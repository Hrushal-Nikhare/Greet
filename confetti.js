  ...
  var h = (function () {
    function t(n) {
      ...
      (this.confettiSpeed = {
        ...
        (this.finalConfettiSpeedX = e(0.2, 0.6, 3)),
        (this.rotationSpeed = f.length ? 0.01 : e(0.03, 0.07, 3) * c()),
        ...
        (this.rotationAngle = "left" === a ? e(0, 0.2, 3) : e(-0.2, 0, 3)),
          ...
          value: function (t, e) {
            ...
            i.x > o && (this.confettiSpeed.x -= n * t),
              (this.currentPosition.x +=
                i.x * ("left" === c ? -this.absCos : this.absCos) * t),
              (this.currentPosition.y =
                this.initialPosition.y -
                i.y * this.absSin * h +
                (0.00125 * Math.pow(h, 2)) / 2),
  ...
  const l = (function () {
    function e() {
      ...
      !(function (t, e) {
        ...
        (this.canvas =
          (((t = document.createElement("canvas")).style.position = "fixed"),
          (t.style.width = "100%"),
          (t.style.height = "100%"),
          (t.style.top = "0"),
          (t.style.left = "0"),
          ...
          value: function () {
            for (
              var t =
                ...
                e = f(t),
                i = e.confettiRadius,
                n = e.confettiesNumber,
                o = e.confettiColors,
                s = e.emojies,
                a = (5 * window.innerHeight) / 7,
                r = {
                  x: 0,
                  y: a,
                },
